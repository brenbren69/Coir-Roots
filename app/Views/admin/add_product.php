...
<head>
    ...
    <title>Add Product | Coir Roots PH</title>
    <style>
        :root {
            --surface: #fffdf8;
...
<body>
    ...
    <main>
        <div class="container">
            <section class="hero">
                <span>Admin Product Creation</span>
                <h1>Add a new product to the catalog.</h1>
                <p>Create a new product record so it can be managed by the admin team and shown in the customer-facing product experience.</p>
            </section>

            <section class="form-card">
                <h2>New Product Details</h2>
                <p>Fill out the basic product information below and save it to the product list.</p>

                <form action="<?= site_url('admin/save_product') ?>" method="post">
                    ...
                    <div class="button-row">
                        ...
                        <button class="button-strong" type="submit">Save Product</button>
                    </div>
                </form>
            </section>
        </div>
